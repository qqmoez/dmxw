    ...
    class OwO {
        constructor(option) {
            const defaultOption = {
                ...
                width: '100%',
                maxHeight: '250px',
                api: 'https://api.anotherhome.net/OwO/OwO.json?v=1.0'
            };
        ...
        init(option) {
            ...
            // fill in HTML
            let html = `
            <div class="OwO-body" style="width: ${option.width}"><div class="OwO-jio"></div><ul class="nav nav-pills nav-secondary nav-pills-no-bd owolist">`;
